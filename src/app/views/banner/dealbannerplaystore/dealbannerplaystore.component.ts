...
@Component({
  selector: 'app-dealbannerplaystore',
  templateUrl: './dealbannerplaystore.component.html',
  styleUrls: ['./dealbannerplaystore.component.scss']
})

export class DealbannerplaystoreComponent implements OnInit {
  ...
  handleImage(files: FileList, imageVariable: number) {
    ...
    if ((file.type == jpegImageType) || (file.type == 'image/jpg') || (file.type == pngImageType) || (file.type == webPImageType)) {
