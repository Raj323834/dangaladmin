...
@Component({
  selector: 'app-homebannerdangalgame',
  templateUrl: './homebannerdangalgame.component.html',
  styleUrls: ['./homebannerdangalgame.component.scss']
})
export class HomebannerdangalgameComponent implements OnInit {
...
validateBannerDetails() {
  ...
  if((this.rank1 == "" && this.rank1 != null) ){}
   ...
   || (this.rank1==this.rank7) || (this.rank1==this.rank8) || (this.rank1==this.rank9) || (this.rank1==this.rank10)
    ...
    this.showAlertBox("Please check row 1, fill in the rank correctly ");
      this.isValid = false;
  }
