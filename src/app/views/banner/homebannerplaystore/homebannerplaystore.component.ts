...
@Component({
  selector: 'app-homebannerplaystore',
  templateUrl: './homebannerplaystore.component.html',
  styleUrls: ['./homebannerplaystore.component.scss']
})
export class HomebannerplaystoreComponent implements OnInit {
  ...
  getBannerDetails = () => {
    ...
    this.bannerService.gethomebanner(UrlConstant.homebanner, params.toString(), AppConstants.NO_QUERY_PARAM, this.ipAddress, userName, '' + Date.now())
      .subscribe(resData => {
        console.log(resData)
  ...
  createRequestBodyandValidations() {
    ...
    if(this.rank1==""){}
    else if ((this.rank1 != "" && this.rank1 != null) && ( this.imageByte1 != null && this.imageByte1.length>0) && (this.navigateTo1 != "" && this.navigateTo1 != null) ) {
      this.rankvalidationArray.push(parseFloat(this.rank1))
        this.bannersData.push({ rank: parseFloat(this.rank1),bannerData: this.imageByte1, code: this.code1, navigateTo: this.navigateTo1})
      } else if (( this.rank1 != null) && (this.url1 !='' && this.url1 != null  )  && (this.navigateTo1 != "" && this.navigateTo1 != null)  ) {
        this.rankvalidationArray.push(parseFloat(this.rank1))
        this.bannersData.push({ rank: parseFloat(this.rank1), url: this.url1,  code: this.code1, navigateTo: this.navigateTo1});
      } else if ((this.rank1 != "" && this.rank1 != null) && ( this.imageByte1 != null && this.imageByte1.length>0) ) {
    this.rankvalidationArray.push(parseFloat(this.rank1))
      this.bannersData.push({ rank: parseFloat(this.rank1),bannerData: this.imageByte1,})
    } else if (( this.rank1 != null) && (this.url1 !='' && this.url1 != null  )  ) {
      this.rankvalidationArray.push(parseFloat(this.rank1))
      this.bannersData.push({ rank: parseFloat(this.rank1), url: this.url1,});
    } else if ((this.rank1 == "") ) {
    } else {
    ...
    if(this.rank2==""){}
    else if ((this.rank2 != "" && this.rank2 != null) && ( this.imageByte2 != null && this.imageByte2.length>0) && (this.navigateTo2 != "" && this.navigateTo2 != null) ) {
      this.rankvalidationArray.push(parseFloat(this.rank2))
        this.bannersData.push({ rank: parseFloat(this.rank2),bannerData: this.imageByte2, code: this.code2, navigateTo: this.navigateTo2})
      } else if (( this.rank2 != null) && (this.url2 !='' && this.url2 != null  )  && (this.navigateTo2 != "" && this.navigateTo2 != null)  ) {
        this.rankvalidationArray.push(parseFloat(this.rank2))
        this.bannersData.push({ rank: parseFloat(this.rank2), url: this.url2,  code: this.code2, navigateTo: this.navigateTo2});
      } else if ((this.rank2 != "" && this.rank2 != null) && ( this.imageByte2 != null && this.imageByte2.length>0) ) {
    this.rankvalidationArray.push(parseFloat(this.rank2))
      this.bannersData.push({ rank: parseFloat(this.rank2),bannerData: this.imageByte2,})
    } else if (( this.rank2 != null) && (this.url2 !='' && this.url2 != null  )  ) {
      this.rankvalidationArray.push(parseFloat(this.rank2))
      this.bannersData.push({ rank: parseFloat(this.rank2), url: this.url2,});
    } else if ((this.rank2 == "") ) {
    } else {
    ...
    if(this.rank3==""){}
    else if ((this.rank3 != "" && this.rank3 != null) && ( this.imageByte3 != null && this.imageByte3.length>0) && (this.navigateTo3 != "" && this.navigateTo3 != null) ) {
      this.rankvalidationArray.push(parseFloat(this.rank3))
        this.bannersData.push({ rank: parseFloat(this.rank3),bannerData: this.imageByte3, code: this.code3, navigateTo: this.navigateTo3})
      } else if (( this.rank3 != null) && (this.url3 !='' && this.url3 != null  )  && (this.navigateTo3 != "" && this.navigateTo3 != null)  ) {
        this.rankvalidationArray.push(parseFloat(this.rank3))
        this.bannersData.push({ rank: parseFloat(this.rank3), url: this.url3,  code: this.code3, navigateTo: this.navigateTo3});
      } else if ((this.rank3 != "" && this.rank3 != null) && ( this.imageByte3 != null && this.imageByte3.length>0) ) {
    this.rankvalidationArray.push(parseFloat(this.rank3))
      this.bannersData.push({ rank: parseFloat(this.rank3),bannerData: this.imageByte3,})
    } else if (( this.rank3 != null) && (this.url3 !='' && this.url3 != null  )  ) {
      this.rankvalidationArray.push(parseFloat(this.rank3))
      this.bannersData.push({ rank: parseFloat(this.rank3), url: this.url3,});
    } else if ((this.rank3 == "") ) {
    } else {
    ...
    if(this.rank4==""){}
    else if ((this.rank4 != "" && this.rank4 != null) && ( this.imageByte4 != null && this.imageByte4.length>0) && (this.navigateTo4 != "" && this.navigateTo4 != null) ) {
      this.rankvalidationArray.push(parseFloat(this.rank4))
        this.bannersData.push({ rank: parseFloat(this.rank4),bannerData: this.imageByte4, code: this.code4, navigateTo: this.navigateTo4})
      } else if (( this.rank4 != null) && (this.url4 !='' && this.url4 != null  )  && (this.navigateTo4 != "" && this.navigateTo4 != null)  ) {
        this.rankvalidationArray.push(parseFloat(this.rank4))
        this.bannersData.push({ rank: parseFloat(this.rank4), url: this.url4,  code: this.code4, navigateTo: this.navigateTo4});
      } else if ((this.rank4 != "" && this.rank4 != null) && ( this.imageByte4 != null && this.imageByte4.length>0) ) {
    this.rankvalidationArray.push(parseFloat(this.rank4))
      this.bannersData.push({ rank: parseFloat(this.rank4),bannerData: this.imageByte4,})
    } else if (( this.rank4 != null) && (this.url4 !='' && this.url4 != null  )  ) {
      this.rankvalidationArray.push(parseFloat(this.rank4))
      this.bannersData.push({ rank: parseFloat(this.rank4), url: this.url4,});
    } else if ((this.rank4 == "") ) {
    } else {
    ...
    if(this.rank5==""){}
    else if ((this.rank5 != "" && this.rank5 != null) && ( this.imageByte5 != null && this.imageByte5.length>0) && (this.navigateTo5 != "" && this.navigateTo5 != null) ) {
      this.rankvalidationArray.push(parseFloat(this.rank5))
        this.bannersData.push({ rank: parseFloat(this.rank5),bannerData: this.imageByte5, code: this.code5, navigateTo: this.navigateTo5})
      } else if (( this.rank5 != null) && (this.url5 !='' && this.url5 != null  )  && (this.navigateTo5 != "" && this.navigateTo5 != null)  ) {
        this.rankvalidationArray.push(parseFloat(this.rank5))
        this.bannersData.push({ rank: parseFloat(this.rank5), url: this.url5,  code: this.code5, navigateTo: this.navigateTo5});
      } else if ((this.rank5 != "" && this.rank5 != null) && ( this.imageByte5 != null && this.imageByte5.length>0) ) {
    this.rankvalidationArray.push(parseFloat(this.rank5))
      this.bannersData.push({ rank: parseFloat(this.rank5),bannerData: this.imageByte5,})
    } else if (( this.rank5 != null) && (this.url5 !='' && this.url5 != null  )  ) {
      this.rankvalidationArray.push(parseFloat(this.rank5))
      this.bannersData.push({ rank: parseFloat(this.rank5), url: this.url5,});
    } else if ((this.rank5 == "") ) {
    } else {
    ...
    if(this.rank6==""){}
    else if ((this.rank6 != "" && this.rank6 != null) && ( this.imageByte6 != null && this.imageByte6.length>0) && (this.navigateTo6 != "" && this.navigateTo6 != null) ) {
      this.rankvalidationArray.push(parseFloat(this.rank6))
        this.bannersData.push({ rank: parseFloat(this.rank6),bannerData: this.imageByte6, code: this.code6, navigateTo: this.navigateTo6})
      } else if (( this.rank6 != null) && (this.url6 !='' && this.url6 != null  )  && (this.navigateTo6 != "" && this.navigateTo6 != null)  ) {
        this.rankvalidationArray.push(parseFloat(this.rank6))
        this.bannersData.push({ rank: parseFloat(this.rank6), url: this.url6,  code: this.code6, navigateTo: this.navigateTo6});
      } else if ((this.rank6 != "" && this.rank6 != null) && ( this.imageByte6 != null && this.imageByte6.length>0) ) {
    this.rankvalidationArray.push(parseFloat(this.rank6))
      this.bannersData.push({ rank: parseFloat(this.rank6),bannerData: this.imageByte6,})
    } else if (( this.rank6 != null) && (this.url6 !='' && this.url6 != null  )  ) {
      this.rankvalidationArray.push(parseFloat(this.rank6))
      this.bannersData.push({ rank: parseFloat(this.rank6), url: this.url6,});
    } else if ((this.rank6 == "") ) {
    } else {
    ...
    if(this.rank7==""){}
    else if ((this.rank7 != "" && this.rank7 != null) && ( this.imageByte7 != null && this.imageByte7.length>0) && (this.navigateTo7 != "" && this.navigateTo7 != null) ) {
      this.rankvalidationArray.push(parseFloat(this.rank7))
        this.bannersData.push({ rank: parseFloat(this.rank7),bannerData: this.imageByte7, code: this.code7, navigateTo: this.navigateTo7})
      } else if (( this.rank7 != null) && (this.url7 !='' && this.url7 != null  )  && (this.navigateTo7 != "" && this.navigateTo7 != null)  ) {
        this.rankvalidationArray.push(parseFloat(this.rank7))
        this.bannersData.push({ rank: parseFloat(this.rank7), url: this.url7,  code: this.code7, navigateTo: this.navigateTo7});
      } else if ((this.rank7 != "" && this.rank7 != null) && ( this.imageByte7 != null && this.imageByte7.length>0) ) {
    this.rankvalidationArray.push(parseFloat(this.rank7))
      this.bannersData.push({ rank: parseFloat(this.rank7),bannerData: this.imageByte7,})
    } else if (( this.rank7 != null) && (this.url7 !='' && this.url7 != null  )  ) {
      this.rankvalidationArray.push(parseFloat(this.rank7))
      this.bannersData.push({ rank: parseFloat(this.rank7), url: this.url7,});
    } else if ((this.rank7 == "") ) {
    } else {
    ...
    if(this.rank8==""){}
    else if ((this.rank8 != "" && this.rank8 != null) && ( this.imageByte8 != null && this.imageByte8.length>0) && (this.navigateTo8 != "" && this.navigateTo8 != null) ) {
      this.rankvalidationArray.push(parseFloat(this.rank8))
        this.bannersData.push({ rank: parseFloat(this.rank8),bannerData: this.imageByte8, code: this.code8, navigateTo: this.navigateTo8})
      } else if (( this.rank8 != null) && (this.url8 !='' && this.url8 != null  )  && (this.navigateTo8 != "" && this.navigateTo8 != null)  ) {
        this.rankvalidationArray.push(parseFloat(this.rank8))
        this.bannersData.push({ rank: parseFloat(this.rank8), url: this.url8,  code: this.code8, navigateTo: this.navigateTo8});
      } else if ((this.rank8 != "" && this.rank8 != null) && ( this.imageByte8 != null && this.imageByte8.length>0) ) {
    this.rankvalidationArray.push(parseFloat(this.rank8))
      this.bannersData.push({ rank: parseFloat(this.rank8),bannerData: this.imageByte8,})
    } else if (( this.rank8 != null) && (this.url8 !='' && this.url8 != null  )  ) {
      this.rankvalidationArray.push(parseFloat(this.rank8))
      this.bannersData.push({ rank: parseFloat(this.rank8), url: this.url8,});
    } else if ((this.rank8 == "") ) {
    } else {
    ...
    if(this.rank9==""){}
    else if ((this.rank9 != "" && this.rank9 != null) && ( this.imageByte9 != null && this.imageByte9.length>0) && (this.navigateTo9 != "" && this.navigateTo9 != null) ) {
      this.rankvalidationArray.push(parseFloat(this.rank9))
        this.bannersData.push({ rank: parseFloat(this.rank9),bannerData: this.imageByte9, code: this.code9, navigateTo: this.navigateTo9})
      } else if (( this.rank9 != null) && (this.url9 !='' && this.url9 != null  )  && (this.navigateTo9 != "" && this.navigateTo9 != null)  ) {
        this.rankvalidationArray.push(parseFloat(this.rank9))
        this.bannersData.push({ rank: parseFloat(this.rank9), url: this.url9,  code: this.code9, navigateTo: this.navigateTo9});
      } else if ((this.rank9 != "" && this.rank9 != null) && ( this.imageByte9 != null && this.imageByte9.length>0) ) {
    this.rankvalidationArray.push(parseFloat(this.rank9))
      this.bannersData.push({ rank: parseFloat(this.rank9),bannerData: this.imageByte9,})
    } else if (( this.rank9 != null) && (this.url9 !='' && this.url9 != null  )  ) {
      this.rankvalidationArray.push(parseFloat(this.rank9))
      this.bannersData.push({ rank: parseFloat(this.rank9), url: this.url9,});
    } else if ((this.rank9 == "") ) {
    } else {
    ...
    if(this.rank10==""){}
    else if ((this.rank10 != "" && this.rank10 != null) && ( this.imageByte10 != null && this.imageByte10.length>0) && (this.navigateTo10 != "" && this.navigateTo10 != null) ) {
      this.rankvalidationArray.push(parseFloat(this.rank10))
        this.bannersData.push({ rank: parseFloat(this.rank10),bannerData: this.imageByte10, code: this.code10, navigateTo: this.navigateTo10})
      } else if (( this.rank10 != null) && (this.url10 !='' && this.url10 != null  )  && (this.navigateTo10 != "" && this.navigateTo10 != null)  ) {
        this.rankvalidationArray.push(parseFloat(this.rank10))
        this.bannersData.push({ rank: parseFloat(this.rank10), url: this.url10,  code: this.code10, navigateTo: this.navigateTo10});
      } else if ((this.rank10 != "" && this.rank10 != null) && ( this.imageByte10 != null && this.imageByte10.length>0) ) {
    this.rankvalidationArray.push(parseFloat(this.rank10))
      this.bannersData.push({ rank: parseFloat(this.rank10),bannerData: this.imageByte10,})
    } else if (( this.rank10 != null) && (this.url10 !='' && this.url10 != null  )  ) {
      this.rankvalidationArray.push(parseFloat(this.rank10))
      this.bannersData.push({ rank: parseFloat(this.rank10), url: this.url10,});
    } else if ((this.rank10 == "") ) {
    } else {
  ...
  validateBannerDetails() {
    ...
    if ((this.rank1 == "" && this.rank1 != null)) { }
      ...
      this.showAlertBox(" Check row 2, fill in the rank correctly ");
      this.isValid = false;
    }
    ...
    if ((this.rank3 == "" && this.rank3 != null)) { }
      ...
      this.showAlertBox(" Check row 3 , fill in the rank correctly");
      this.isValid = false;
    }
    ...
    if ((this.rank4 == "" && this.rank4 != null)) { }
      ...
      this.showAlertBox(" Check row 4 , fill in the rank correctly");
      this.isValid = false;
    }
    ...
    if ((this.rank5 == "" && this.rank5 != null)) { }
      ...
      this.showAlertBox(" Check row 5 , fill in the rank correctly");
      this.isValid = false;
    }
    ...
    if ((this.rank6 == "" && this.rank6 != null)) { }
      ...
      this.showAlertBox(" Check row 6 , fill in the rank correctly");
      this.isValid = false;
    }
    ...
    if ((this.rank7 == "" && this.rank7 != null)) { }
      ...
      this.showAlertBox(" Check row 7 , fill in the rank correctly");
      this.isValid = false;
    }
    ...
    if ((this.rank8 == "" && this.rank8 != null)) { }
      ...
      this.showAlertBox(" Check row 8 , fill in the rank correctly");
      this.isValid = false;
    }
    ...
    if ((this.rank9 == "" && this.rank9 != null)) { }
      ...
      this.showAlertBox(" Check row 9 , fill in the rank correctly");
      this.isValid = false;
    }
    ...
    if ((this.rank10 == "" && this.rank10 != null)) { }
      ...
      this.showAlertBox(" Check row 10, fill in the rank correctly ");
      this.isValid = false;
    }
  ...
  resetAll(){
    ...
    reset(variable:number){
      if(variable==1){ this.rank1 = '';this.url1 = "";this.imageByte1 = [];this.urlimageRead1  = '';this.code1 = ""; this.navigateTo1 = "";}
      if(variable==2){ this.rank2 = '';this.url2 = "";this.imageByte2 = [];this.urlimageRead2  = ''; this.code2 = ""; this.navigateTo2 = "";}
      if(variable==3){ this.rank3 = '';this.url3 = "";this.imageByte3 = [];this.urlimageRead3  = ''; this.code3 = ""; this.navigateTo3 = "";}
      if(variable==4){ this.rank4 = '';this.url4 = "";this.imageByte4 = [];this.urlimageRead4  = ''; this.code4 = ""; this.navigateTo4 = "";}
      if(variable==5){ this.rank5 = '';this.url5 = "";this.imageByte5 = [];this.urlimageRead5  = ''; this.code5 = ""; this.navigateTo5 = "";}
      if(variable==6){ this.rank6 = '';this.url6 = "";this.imageByte6 = [];this.urlimageRead6  = ''; this.code6 = ""; this.navigateTo6 = "";}
      if(variable==7){ this.rank7 = '';this.url7 = "";this.imageByte7 = [];this.urlimageRead7  = ''; this.code7 = ""; this.navigateTo7 = "";}
      if(variable==8){ this.rank8 = '';this.url8 = "";this.imageByte8 = [];this.urlimageRead8  = ''; this.code8 = ""; this.navigateTo8 = "";}
      if(variable==9){ this.rank9 = '';this.url9 = "";this.imageByte9 = [];this.urlimageRead9  = ''; this.code9 = ""; this.navigateTo9 = "";}
      if(variable==10){ this.rank10 = '';this.url10 = "";this.imageByte10 = [];this.urlimageRead10  = ''; this.code10 = ""; this.navigateTo10 = "";}
    }
}