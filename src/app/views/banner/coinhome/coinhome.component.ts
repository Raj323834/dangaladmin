...
@Component({
  selector: 'app-coinhome',
  templateUrl: './coinhome.component.html',
  styleUrls: ['./coinhome.component.scss']
})
export class CoinhomeComponent implements OnInit {
  ...
  ProdOrDevPermission() {
    ...
    if (this.apiurltest == 'prodKey') {
      this.source = 'PROD_CO_IN'
      this.getBannerDetails();
    }
    else {
      this.showAlertBox('Only Available for Production')
    }
  }
  ...
  validateBannerDetails() {
    ...
    if ((this.rank6 == "" && this.rank6 != null)) { }
      ...
      this.showAlertBox("Pleae check row 6 , fill in the rank correctly");
      this.isValid = false;
    }
