...
@Component({
  templateUrl: 'freeGameReports.component.html',
  styleUrls: ['freeGameReports.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class FreeGameReportsComponent implements OnInit{
  private title:string = 'FreeGame Report';
  private excel :any= [];
  ...
  ngOnInit() {
    const accessPermission = HelperService.getModulePermissions(PermissionNames.FREE_GAME_REPORT);
...
closeAlertModal = () => {
  ...
  getFreeGameReports = () => {
    ...
    if (isValid) {
      ...
      this.reportService.getCashReport(UrlConstant.getFreeReportUrl, AppConstants.NO_URL_PARAM, param, this.ipAddress, userName, '' + Date.now())
      .subscribe(resData => {
          this.spinnerService.hide();
          if (resData.result === Responses.SUCCESS) {
            this.title = param.game_name + '_Free_';
