...
@Component({
  templateUrl: 'dgToPokerReport.component.html',
  styleUrls: ['dgToPokerReport.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class DgToPokerTransferReportComponent {
  ...
  private title: string = 'DGToPoker Report';
  private excel: any = [];
  ...
  getDgPokerToReportDetails = () => {
    ...
    if (isValid) {
      ...
      this.reportService.getPokerToDgReport(UrlConstant.getDgToPokerReportUrl, AppConstants.NO_URL_PARAM, this.searchParamsForm.value, this.ipAddress, userName, '' + Date.now())
        .subscribe(resData => {
          this.excel = [];
          this.allData = [];
