...
import { PoketTournamentStatsReportDataModel } from '../../../models/reports/poketTournamentStatsReport/PoketTournamentStatsReportDataModel';
...
@Component({
  templateUrl: 'tournamentReports.component.html',
  styleUrls: ['tournamentReports.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class TournamentReportsComponent {
  private userName: string = "";
  private ipAddress: string = '00.00.00.00';

  //general page loading
  dataSource: MatTableDataSource<any>;
  allData: PoketTournamentStatsReportDataModel[];
  columns: string[] = [
    'playerName',
    'winAmount',
    'bountyWinAmount',
  ...
  private title: string = 'Poker Tournament Report';
  ...
  ngOnInit() {
    ...
    const accessPermission = HelperService.getModulePermissions(PermissionNames.TOURNAMENT_REPORT);
 ...
 getTournamentReportDetails = () => {
    ...
    if (isValid) {
      ...
      this.reportService.getPokerTournamentStatsReport(UrlConstant.getPokerTournamentReportUrl, AppConstants.NO_URL_PARAM, this.searchParamsForm.value, this.ipAddress, userName, '' + Date.now())
      .subscribe(resData => {
        this.excel = [];
        this.allData = [];
